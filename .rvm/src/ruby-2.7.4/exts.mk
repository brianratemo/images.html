...
ECHO1 = $(V:1=@:)
ECHO = $(ECHO1:0=@echo)
extensions = ext/dbm/. ext/digest/. ext/digest/bubblebabble/. \
	     ext/digest/md5/. ext/digest/rmd160/. ext/digest/sha1/. \
	     ext/digest/sha2/. ext/psych/. ext/fiddle/. \
	     ...
	     ext/json/generator/. ext/json/parser/. ext/coverage/. \
	     ext/openssl/. ext/sdbm/. ext/pty/. ext/readline/. \
	     ext/io/console/. ext/io/nonblock/. ext/io/wait/. \
	     ext/etc/. ext/stringio/. ext/strscan/. ext/nkf/. \
	     ext/fiber/. ext/gdbm/. ext/objspace/. ext/ripper/. \
	     ext/continuation/. ext/monitor/. ext/rbconfig/sizeof/. \
	     ext/bigdecimal/. ext/date/. ext/zlib/. ext/fcntl/. \
	     ext/cgi/escape/. ext/socket/. ext/syslog/. ext/pathname/. \
	     ext/rubyvm/. ext/racc/cparse/.
EXTOBJS = dmyext.o
